...
- [`spt4-vs-spt41-deofuscacao-gclass.html`](spt4-vs-spt41-deofuscacao-gclass.html) — versão visual deste documento (diagrama de fluxo + tabelas), mesma análise, formato para compartilhar
