...
|---|---|---|---|---|
| 001 | prevencao-npe-extracao-raid | Eliminar NullReferenceException em PointOfView durante encerramento ou extração de raid validando ciclo de vida do Player em OverlayController | [001-prevencao-npe-extracao-raid/](./001-prevencao-npe-extracao-raid/) | ⚪ |
