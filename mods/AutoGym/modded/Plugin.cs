...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        SwapWorkoutBodySkin = Config.Bind("Visuals", "Swap Workout Body Skin", true, "Temporarily swaps the character's torso to the configured workout skin during hideout gym workouts. Restored when the workout ends.");
        WorkoutBodySkinId = Config.Bind("Visuals", "Workout Body Skin Id", "66a25a3af12f29d8a2599527", "Customization template id (Body part) applied during workouts. Default: Tagilla's Chest from the AllTheClothes mod. If the template does not exist, no swap happens.");
