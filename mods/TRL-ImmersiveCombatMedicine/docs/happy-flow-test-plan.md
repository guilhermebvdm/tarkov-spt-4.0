...
- [ ] **P1** — F12 → BepInEx → as versões batem com o que foi implantado. Estado atual: `TRLImmersiveCombatMedicine` **1.13.1** e `TRL Fixes` **1.1.1**. Se não bater, é build velha no jogo: pare aqui.
...
| **H11** | Quebre uma perna (não zere). Depois quebre um braço. Depois zere o estômago | Fala **dedicada** de perna quebrada; depois de mão quebrada; depois grito de dor. Com analgésico ativo: **silêncio**. Bot ferido: sempre silêncio | ✅ 1.13.1 |
