...
namespace TRLImmersiveCombatMedicine.Trauma
{
    ...
    public static class DamageTriggerPatch
    {
        ...
        static bool Prefix(Player __instance, ref DamageInfoStruct damageInfo, EBodyPart bodyPartType, out float __state)
        {
            __state = -1f;
        ...
        static void Postfix(Player __instance, ref DamageInfoStruct damageInfo, EBodyPart bodyPartType, float __state)
        {
            ...
            // braço zerado, gateado pela key inerte "Sistema de Braços" — removida no item 010): o feedback de entrada agora é o toast
