...
namespace TRLImmersiveCombatMedicine.Trauma
{
    ...
    /// O agachar do estômago (p=75/25) é rolado/publicado pelo item 006; desmaio pelo 007.
    /// InvoluntaryProneOnce é a queda one-shot sem bloqueio ao quebrar 1 perna.</summary>
    public enum TraumaOneShotKind { InvoluntaryCrouch, InvoluntaryFall, InvoluntaryProneOnce }
