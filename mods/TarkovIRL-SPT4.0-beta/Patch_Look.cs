...
internal class Patch_Look : ModulePatch
{
  ...
  {
    if ((__instance == null) || !__instance.IsYourPlayer || __instance.MovementContext.CurrentState.Name == EPlayerState.Stationary || !PrimeMover.IsSmallMovementsEffect.Value || !PrimeMover.EnableMod.Value || Patch_CalculateCameraPosition_HandLayers.IsLeftShoulderOrDelay)
      return;
