...
**Versão base:** 1.2.2 · **Licença:** Unknown
**Upstream:** https://github.com/emilanderss0n/SPT-Menu-Overhaul/ @ `71bb6107db5399febd8691dc6f4cdb76853b9bfc` (branch `main`)
**Forge:** 
...
```bash
diff -r mods/SPT-Menu-Overhaul/original/ mods/SPT-Menu-Overhaul/modded/
```
...
_Adicionado em 2026-06-08T22:11:39Z_
