...
namespace Band_Aid
{
    public class BandAidUI : MonoBehaviour
    {
        ...
        private static void CacheTypes()
        {
            ...
            // === EFEITOS SINCRONIZADOS PELO FIKA (usam GInterfaces comuns) ===
            // ActiveHC e NetworkHC têm classes diferentes, mas mesma GInterface.
            // Exemplo: ActiveHC.HeavyBleeding e NetworkHC.HeavyBleeding ambos implementam GInterface314.
            // FindActiveEffect<GInterface314> funciona em QUALQUER HealthController.
            ...
            _contusionType = typeof(GInterface326);    // Contusion
            _tremorType = typeof(GInterface335);       // Tremor

            // === EFEITOS NÃO SINCRONIZADOS (só existem no ActiveHC) ===
            // Pain e Intoxication não existem no NetworkHealthControllerAbstractClass.
            // Para jogadores remotos, esses ícones não aparecerão (limitação do Fika).
        ...
        private void CreateEcg(Transform parent)
        {
            ...
            _ecgLabel = MakeText(ecgBg.transform, "EcgLabel",
                ...
                "♥", 17, TextAnchor.MiddleCenter, COL_SUBTITLE, FontStyle.Normal);
        ...
        public void Update()
        {
            ...
            try
            {
                ...
                {
                    // Player.Position = posição dos pés. Dois jogadores lado a lado ~1.5m.
                    // SphereCast usa câmera (olhos) — detecção é diferente de auto-close.
                    ...
                    if (dist > 1.0f)
                    {
                        ...
                        BandAidPlugin.Instance?.DeactivateMedicModeExternal();
                        return;
                    }
                }
