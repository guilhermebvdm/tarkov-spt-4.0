...
internal static class EfficiencyController
{
  ...
  {
    ValueStruct hydration = ((GInterface355) player.HealthController).Hydration;
    float normalized1 = ((ValueStruct) ref hydration).Normalized;
    ValueStruct energy = ((GInterface355) player.HealthController).Energy;
    float normalized2 = ((ValueStruct) ref energy).Normalized;
    ...
    ValueStruct bodyPartHealth = ((GInterface355) player.HealthController).GetBodyPartHealth((EBodyPart) 7, false);
    float normalized3 = ((ValueStruct) ref bodyPartHealth).Normalized;
