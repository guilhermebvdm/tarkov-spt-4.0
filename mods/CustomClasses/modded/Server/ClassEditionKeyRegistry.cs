...
///     da chave real: com <c>settings.jsonc language=pt/en</c> o boot re-chaveia a edition para
///     <c>displayName[lang]</c> (CustomClassesMod.ApplyLauncherLanguage, privado), então <c>def.name</c>
///     NÃO é confiável como chave. Limpo em <see cref="ClassRegistrar.Remove"/>.
