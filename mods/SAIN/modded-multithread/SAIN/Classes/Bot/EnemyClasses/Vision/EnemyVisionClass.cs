...
public class EnemyVisionClass(EnemyData enemyData) : EnemyBase(enemyData, enemyData.Enemy.Bot)
{
    ...
    // ref: AUD-09-06 - Cache intra-frame de ganho de visão (O(1) no mesmo frame)
    public int LastGainSightFrame { get; set; } = -1;
    public float CachedGainSightModifier { get; set; } = 1f;
