...
| **Movement** | [`MovementPatches`](../modded/SAIN/Patches/MovementPatches.cs) | `BotMover.SetPose / SetSpeed` | Força transições suaves de postura (agachado/em pé) e corrida tática. |
