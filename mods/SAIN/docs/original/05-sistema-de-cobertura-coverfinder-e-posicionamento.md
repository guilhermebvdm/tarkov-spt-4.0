...
flowchart TD
    ...
    CreateCoverPoint --> SortPoints["Ordena Pontos por:<br>1. Distância até o Bot<br>2. Ângulo de Proteção<br>3. Segurança contra Terceiros"]
...
| `ProtectionDirection` | `Vector3` | Vetor unitário normal que indica para qual direção a proteção é efetiva contra projéteis. |
...
O SAIN introduz mecânicas de inclinação de tronco adaptativas ([`LeanSetting`](../modded/SAIN/SAINEnum.cs)):
