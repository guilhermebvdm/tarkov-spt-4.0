...
O gerenciamento de configurações é centralizado no [`PresetHandler`](../modded/SAIN/Plugin/PresetHandler.cs) e gravado em formato JSON na pasta `BepInEx/plugins/SAIN/Presets/`:
...
- **Exportação de Presets Customizados:** Permite criar novos perfis de dificuldade e compartilhá-los entre jogadores.
