...
| `DogFight` | Inimigo extremamente próximo (< 4–8m), com linha de visão aberta ou em corrida para cima do bot. | Dispara em movimento contínuo enquanto se desloca lateralmente para evitar tiros na cabeça. |
...
| `MeleeAttack` | Bot sem munição em armas de fogo ou boss Tagilla com seu martelo ativado. | Investida direta em sprint armado com arma branca. |
