...
| **Lanternas e Lasers** | [`FlashLightDazzleClass`](../modded/SAIN/Classes/Bot/Sense/FlashLightDazzleClass.cs) | Lanternas táticas apontadas diretamente para o rosto do bot ofuscam sua visão (*Dazzle*), aumentando drasticamente seu tempo de reação. |
...
| `Prone` / `Looting` / `Reload` | 5–12m | Sons sutis que denunciam ações vulneráveis do inimigo. |
| `GrenadePin` / `GrenadeDraw` | 10–18m | Aciona alerta imediato de perigo de granada. |
| `BulletImpact` / Fly-By | 10m do projétil | Aciona o estado de *Under Fire*, forçando busca emergencial de abrigo. |
