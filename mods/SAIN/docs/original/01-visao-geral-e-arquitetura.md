...
- [`PlayerSpawnTracker`](../modded/SAIN/Classes/PlayerManager/Players/PlayerSpawnTracker.cs): Monitora a entrada e saída de qualquer jogador humano ou bot na raid, instanciando seu respectivo [`PlayerComponent`](../modded/SAIN/Components/PlayerComponent.cs).
...
No modo cooperativo **FIKA**, o SAIN implementa verificações dedicadas no [`AddGameWorldPatch`](../modded/SAIN/Patches/GameWorld/AddGameWorldPatch.cs) e [`ModDetection`](../modded/SAIN/Helpers/ModDetection.cs):
