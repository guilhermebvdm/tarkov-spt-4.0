...
> Todos os pontos, estruturas e jobs descritos neste documento serão implementados e validados **exclusivamente na versão [`mods/SAIN/modded-multithread/`](file:///d:/Projetos/GITHUB%20TARKOV/tarkov-spt-4.0/mods/SAIN/modded-multithread/)**.  
