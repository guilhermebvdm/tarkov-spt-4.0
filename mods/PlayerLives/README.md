...
**Versão base:** 1.2.5 · **Licença:** see LICENSE
**Upstream:** https://github.com/gitTerebi/PlayerLives.git @ `712ad338d1250d36c4904ce8845700564039783e` (branch `main`)
**Forge:** 
...
Grafo do código deste mod (graphify): [`GRAPH_REPORT.md`](../../references/graphs/mods/PlayerLives/GRAPH_REPORT.md). Regenerar após mudanças: `/update-mod-graph PlayerLives` (ou `bash scripts/update-graphs.sh PlayerLives`).

## Comparar modificações com o original

```bash
diff -r mods/PlayerLives/original/ mods/PlayerLives/modded/
```
...
_Adicionado em 2026-08-01T23:24:12Z_
