...
**Upstream:** https://github.com/gitTerebi/Simple-Declutter.git @ `776b5560418db1eb8840b23de8ac9c2b54137c6f` (branch `3.11`)
**Forge:** 
...
Grafo do código deste mod (graphify): [`GRAPH_REPORT.md`](../../references/graphs/mods/Simple-Declutter/GRAPH_REPORT.md). Regenerar após mudanças: `/update-mod-graph Simple-Declutter` (ou `bash scripts/update-graphs.sh Simple-Declutter`).

## Comparar modificações com o original

```bash
diff -r mods/Simple-Declutter/original/ mods/Simple-Declutter/modded/
```
...
_Adicionado em 2026-09-15T03:52:08Z_
