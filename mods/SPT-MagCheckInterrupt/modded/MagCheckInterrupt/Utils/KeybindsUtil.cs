...
public static class KeybindsUtil
{
    ...
    {
        // AUD-01-07: Null-safety defensiva caso os keybinds ainda não tenham sido inicializados
        if (_reloadKeybind?.KeyCombinationState_0 == null || _checkKeybind?.KeyCombinationState_0 == null)
        {
            return false;
        }
