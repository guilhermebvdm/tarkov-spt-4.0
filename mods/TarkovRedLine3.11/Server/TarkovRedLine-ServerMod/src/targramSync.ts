...
//                     };
//                 });
//                 // await supabaseRequest("POST", "posts", posts);
//                 // if (logger && typeof logger.success === 'function') {
//                 //     logger.success(`[Targram] Auto-post gerado: +${newAchIds.length} conquista(s) p/ ${displayName}`);
//                 // }
//             }
//         }
// 
...
//                 // Posta somente se level subir (level > oldLevel). Ignora wipes de wipe server.
...
//                 // await supabaseRequest("POST", "posts", posts);
//                 // if (logger && typeof logger.success === 'function') {
//                 //     logger.success(`[Targram] Auto-post gerado: +${upgradedAreas.length} hideout upgrade(s) p/ ${displayName}`);
//                 // }
//             }
//         }
// 
...
//                         }
//                     } else {
//                         // Perfil em processo inicial de criação (não quebra o SPT, a gente só marca como lido e tenta a próxima vez)
//                         lastModifiedMap[sessionID] = stats.mtimeMs;
//                     }
//                 }
//             } catch (e) {
//                 // Erro ao ler arquivo específico (talvez bloqueado/lock de gravação por uns milissegundos). Ignoramos.
//             }
//         }
//         
...
//     }, 20000); // 20s Ping
// 
//     // Monitora modificações silenciosamente a cada 5 minutos
//     setInterval(() => {
//         checkProfilesFolder(logger);
