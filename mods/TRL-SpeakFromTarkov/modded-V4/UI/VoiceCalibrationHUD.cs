...
namespace TRL_SpeakFromTarkov.UI
{
    ...
    public class VoiceCalibrationHUD : MonoBehaviour
    {
        ...
        // AUD-03-06: GUIStyle cacheados — antes, `new GUIStyle(...)` era alocado a cada OnGUI/DrawXScreen.
        private GUIStyle? _headerStyle;
        private GUIStyle? _subHeaderStyle;
        private GUIStyle? _phraseBoxStyle;
        private GUIStyle? _btnStyle;
        private GUIStyle? _descStyle;
        private GUIStyle? _instructionStyle;
        private GUIStyle? _recStatusStyle;
        ...
        private void OnGUI()
        {
            ...
            if (_phraseBoxStyle == null) _phraseBoxStyle = new GUIStyle(GUI.skin.box)
            {
                fontSize = 13,
            ...
            if (_btnStyle == null) _btnStyle = new GUIStyle(GUI.skin.button)
            {
                fontSize = 12,
                fontStyle = FontStyle.Bold,
                alignment = TextAnchor.MiddleCenter,
            ...
            GUI.Label(new Rect(posX, posY + 15, modalW, 25), "VOICE CALIBRATION WIZARD", _headerStyle);

            switch (CurrentStep)
            {
                case CalibrationStep.Intro:
                    DrawIntroScreen(posX, posY, modalW, modalH, _subHeaderStyle, _btnStyle);
                    break;
                ...
                case CalibrationStep.Whisper:
                    DrawRecordingStep(posX, posY, modalW, modalH, "STEP 1 OF 3: WHISPER",
                        ...
                        CalibrationStep.Normal, _subHeaderStyle, _phraseBoxStyle, _btnStyle);
                    break;
                ...
                case CalibrationStep.Normal:
                    DrawRecordingStep(posX, posY, modalW, modalH, "STEP 2 OF 3: NORMAL VOICE",
                        ...
                        CalibrationStep.Loud, _subHeaderStyle, _phraseBoxStyle, _btnStyle);
                    break;
                ...
                case CalibrationStep.Loud:
                    DrawRecordingStep(posX, posY, modalW, modalH, "STEP 3 OF 3: LOUD VOICE / SHOUT",
                        ...
                        CalibrationStep.Summary, _subHeaderStyle, _phraseBoxStyle, _btnStyle);
                    break;

                case CalibrationStep.Summary:
                    DrawSummaryScreen(posX, posY, modalW, modalH, _subHeaderStyle, _btnStyle);
                    break;
            }
        }
        ...
        private void DrawIntroScreen(float posX, float posY, float modalW, float modalH, GUIStyle subStyle, GUIStyle btnStyle)
        {
            ...
            if (_descStyle == null) _descStyle = new GUIStyle(GUI.skin.label)
            {
                fontSize = 12,
            ...
            GUI.Label(new Rect(posX + 35, posY + 85, modalW - 70, 160), infoText, _descStyle);
        ...
        private void DrawRecordingStep(float posX, float posY, float modalW, float modalH, string stepTitle, string phraseText, CalibrationStep nextStep, GUIStyle subStyle, GUIStyle phraseStyle, GUIStyle btnStyle)
        {
            ...
            if (_instructionStyle == null) _instructionStyle = new GUIStyle(GUI.skin.label)
            {
                fontSize = 11,
                alignment = TextAnchor.MiddleCenter,
            ...
            GUI.Label(new Rect(posX + 20, posY + 70, modalW - 40, 20), "Hold the button below and read out loud the phrase:", _instructionStyle);
            ...
            // AUD-03-06: estilo cacheado (alocado 1x), cor dinâmica atualizada por chamada
            // (escrita simples, não alocação) — depende de _isRecordingPhase a cada frame.
            if (_recStatusStyle == null) _recStatusStyle = new GUIStyle(GUI.skin.label)
            {
                fontSize = 11,
                alignment = TextAnchor.MiddleCenter
            };
            _recStatusStyle.normal.textColor = _isRecordingPhase ? Color.green : Color.gray;
            ...
            GUI.Label(new Rect(posX, posY + 190, modalW, 20), statusMsg, _recStatusStyle);
        ...
        private void DrawSummaryScreen(float posX, float posY, float modalW, float modalH, GUIStyle subStyle, GUIStyle btnStyle)
        {
            ...
            if (_summaryStyle == null) _summaryStyle = new GUIStyle(GUI.skin.label)
            {
                fontSize = 11,
                alignment = TextAnchor.MiddleCenter,
            ...
            GUI.Label(new Rect(posX + 30, posY + 75, modalW - 60, 160), summaryText, _summaryStyle);
