...
namespace TRL_SpeakFromTarkov.UI
{
    ...
    public class InRaidVoipHUD : MonoBehaviour
    {
        ...
        // AUD-03-16: reutilizado em GetWorldCorners() — evita alocar Vector3[4] por OnGUI Repaint.
        ...
        private void Update()
        {
            ...
            {
                // AUD-03-13: reseta a captura de posição-base sempre que o painel precisa ser
                // re-buscado (raid nova, painel recriado) — sem isso, a raid seguinte herdava o
                // deslocamento calculado a partir da posição-base da raid anterior.
        ...
        private void OnGUI()
        {
            ...
            {
                // AUD-03-16: _panelCorners é campo de instância reutilizado — antes, um Vector3[4]
                // novo era alocado a cada OnGUI Repaint enquanto o HUD in-raid estava visível.
