...
{
    [BepInPlugin("trl.speakfromtarkov", "TRL-SpeakFromTarkov", "1.6.1")]
    ...
    public class VoIPPlugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            // AUD-015: roteia a voz de outros jogadores pelo mixer de áudio nativo do jogo
            // (BetterAudio.ObservedPlayerSpeechMixer), habilitando o reverb ambiental por sala/
            // corredor que o jogo já aplica via AudioMixerSnapshot. Toggle novo porque o efeito
            // de roteamento não foi validado em todos os mapas/ambientes em teste real ainda.
            EnableNativeReverb = Config.Bind("Network & 3D Audio", "Enable Native Reverb", true,
                new ConfigDescription("Routes remote player voice through the game's native audio mixer, applying room/corridor reverb automatically. Disable if you notice unexpected volume behavior. Default: true"));
            ...
            // AUD-03-15: FikaVoipSendPatch/FikaVoipReceivePatch removidos (código morto — ver GameSessionPatcher.cs)
