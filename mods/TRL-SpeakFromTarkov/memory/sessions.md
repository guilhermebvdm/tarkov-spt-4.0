...
- **Correção de Erro HTTP 415 (UnsupportedMediaType):** Adicionado atributo `[Consumes("application/json", "text/plain", "application/octet-stream", "*/*")]` e leitor de fallback de payload bruto em [SftChannelController.cs](file:///d:/Projetos/GITHUB%20TARKOV/tarkov-spt-4.0/mods/TRL-SpeakFromTarkov/Server/TRL-SpeakFromTarkov.Server/Controllers/SftChannelController.cs#L40), eliminando os erros de `UnsupportedMediaType` no cliente BepInEx.
