...
internal class HeadRotController
{
  ...
  {
    HeadRotController._headRotLerp = Vector3.Lerp(HeadRotController._headRotLerp, HeadRotController._headRotLerpTarget, dt * HeadRotController._HeadRotLerpSpeed);
  }
  ...
  public static Vector3 GetHeadRotThisFrame(Vector3 headRotThisFrame)
  {
    ...
    HeadRotController._headRotLerpTarget = Vector3.op_Addition(HeadRotController._headRotLerpTarget, reloadHeadOffset);
    ...
    return Vector3.op_Addition(vector3, HeadRotController._headRotLerp);
  }
}
