...
// Type: RealismMod.VisualEffects.PrismEffectsDisablePatch
...
public class PrismEffectsDisablePatch : ModulePatch
{
  ...
  {
    return (MethodBase) typeof (PrismEffects).GetMethod("OnDisable", BindingFlags.Instance | BindingFlags.Public);
  }
  ...
  private static void PatchPostFix(PrismEffects __instance)
  {
    if (!(((Object) ((Component) __instance).gameObject).name == "FPS Camera") || !Object.op_Equality((Object) ScreenEffectsController.PrismEffects, (Object) __instance))
      return;
    ScreenEffectsController.PrismEffects = (PrismEffects) null;
  }
}
