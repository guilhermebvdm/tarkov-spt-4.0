...
public static class PlayerState
{
  ...
  public static float ImmuneSkillWeak = 0.0f;
  public static float ImmuneSkillStrong = 0.0f;
  public static float StressResistanceFactor = 0.0f;
  public static float VitalityFactorStrong = 0.0f;
  public static float AimMoveSpeedInjuryMulti = 1f;
  public static float ErgoDeltaInjuryMulti = 1f;
  public static float StrengthSkillAimBuff = 0.0f;
  public static float StrengthWeightBuff = 0.0f;
  public static float EnduranceSkill = 0.0f;
  public static bool IsAllowedADS = true;
  public static float BaseSprintSpeed = 1f;
  public static EnvironmentType EnviroType = (EnvironmentType) 0;
  public static EPlayerBtrState BtrState = (EPlayerBtrState) 0;
  ...
  public static float WeaponSkillErgo = 0.0f;
  ...
  public static float AimSkillADSBuff = 0.0f;
  ...
  public static float HealthResourceRateFactor = 0.0f;
