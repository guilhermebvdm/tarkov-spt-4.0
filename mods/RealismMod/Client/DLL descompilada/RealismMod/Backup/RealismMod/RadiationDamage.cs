...
// Type: RealismMod.RadiationDamage
  ...
  GInterface323
{
  ...
  public virtual void RegularUpdate(float deltaTime)
  {
    ...
    {
      double num = (double) this.HealthController.ApplyDamage(this._bodyPart, -this._hpPerTick, GClass2855.RadiationDamage);
      ...
      this.HealthController.ChangeHealth(this._bodyPart, this._hpPerTick, GClass2855.RadiationDamage);
  }
}
