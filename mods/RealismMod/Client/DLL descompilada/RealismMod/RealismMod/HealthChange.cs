...
public class HealthChange : ActiveHealthController.GClass2813, IEffect, GInterface308, GInterface323
{
  ...
  public virtual void RegularUpdate(float deltaTime)
  {
    ...
    if ((double) this._hpPerTick < 0.0)
    {
      ...
      this.HealthController.ChangeHealth(this._bodyPart, this._hpPerTick, GClass2855.Existence);
  }
}
