...
**Versão base:** unknown · **Licença:** see LICENSE
**Upstream:** https://github.com/shengzhanzhe/stancesAndCameraPositionSPT4.0.11.git @ `3304278846d0eb83eea8a6a00f060bf3526b2e90` (branch `main`)
**Forge:** 
...
```bash
diff -r mods/stancesAndCameraPositionSPT4.0.11/original/ mods/stancesAndCameraPositionSPT4.0.11/modded/
```
...
_Adicionado em 2026-05-07T23:26:28Z_
