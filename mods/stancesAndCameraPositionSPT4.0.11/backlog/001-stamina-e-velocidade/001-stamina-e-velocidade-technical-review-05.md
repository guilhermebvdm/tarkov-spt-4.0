...
**Reviews anteriores:** [01](001-stamina-e-velocidade-technical-review-01.md) · [02](001-stamina-e-velocidade-technical-review-02.md) · [03](001-stamina-e-velocidade-technical-review-03.md) · [04](001-stamina-e-velocidade-technical-review-04.md)
**Data:** 2026-05-08
...
**Resolução:** `_raidEnded` declarado como `private static bool _raidEnded = true;` em [§5 (StanceManager additions)](001-stamina-e-velocidade-technical-spec.md#5-stubs-de-código). `OnRaidStart` zera (`_raidEnded = false`); `OnRaidEnd` checa o flag e só executa cleanup se houve raid ativa. Comentário inline explica a semântica.
...
**Decisão:** `[x]` **Aceitar sugestão** · ✅ Resolvido em 2026-05-08
**Resolução:** Parágrafo "Cycle e Stance 0" adicionado em [§1 "Modelo de stance"](001-stamina-e-velocidade-technical-spec.md#1-estratégia), explicitando que cycle voltando a Default re-arma drain e como desativar via F12.
...
**Decisão:** `[x]` **Aceitar sugestão** · ✅ Resolvido em 2026-05-08
**Resolução:** XMLDoc adicionada em [§5 (StanceManager additions)](001-stamina-e-velocidade-technical-spec.md#5-stubs-de-código) explicitando estratégia de candidatos: nome do evento público primeiro (estável), `action_N` do decompilador como fallback, falha logada via `HasMissingReflection` no Awake.
