...
- Spec técnica: [001-stamina-e-velocidade-02-spec-tech.md](001-stamina-e-velocidade-02-spec-tech.md)
...
| 2026-05-09 | Fix 01: Recovery não funcionava — `GetHandsRestorationFunc` retorna 0 em hipfire. Redesign: `StaminaMode` + `StaminaIntensity` substituídos por `StaminaMultiplier` unificado. Ver [001-stamina-e-velocidade-06-fix-01.md](001-stamina-e-velocidade-06-fix-01.md) |
