...
{
    /// <summary>
    /// Item 017 (F0) — instrumentação `Debug Transition Metrics`: mede cada transição de pose (stance↔stance,
    ...
    ///
    /// Decisões do review técnico 01 (ver 017-...-02-spec-tech-F0.md):
    ...
    public class TransitionMetrics
    {
        ...
        {
            // CR2-1 (🔴 code-review (item 016, reaproveitado no 017)): desligar a flag no MEIO de uma medição deixava _measuring órfão —
