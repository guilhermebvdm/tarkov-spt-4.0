...
[BepInPlugin("com.shwng.fpscamerastances", "shwngFpsCameraStances4", "2.11.0")]
public class Plugin : BaseUnityPlugin
{
        ...
        (Stance Stance, string Section, float StaminaMultiplier, bool ModSpeed, int Multiplier, bool ApplyProne, bool SnapOnFire, bool AdsWaypoint) d)
    {
        ...
        return new StanceConfig
        {
            ...
            // ⚠️ Order -1/-2 = FIXO abaixo do RODAPÉ de qualquer seção de stance (a entry mais baixa é
            // Snap to Stance 0 on Fire = 0). As entries de rotação/posição usam Orders ABSOLUTOS distintos por
            // stance (S1 ~22-28, S2 ~15-21, S3 ~8-14), então um Order relativo baixo cairia em posição diferente
            // em cada seção e COLIDIRIA na Stance 2 (code-review v2.7.1 #1). -1/-2 põe o waypoint no FIM de TODAS
