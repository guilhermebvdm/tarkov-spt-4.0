...
public class Plugin : BaseUnityPlugin
{
    ...
    private const string Stance0Section = "Stance 0";
    ...
    public void Update()
    {
        ...
        StanceManager.TickStanceStamina();              // backlog 001: drain manual em hipfire
        ...
        (Stance Stance, string Section, EStanceStaminaMode Mode, float Intensity, bool ModSpeed, int Multiplier, bool ApplyProne) d)
    {
        ...
        return new StanceConfig
        {
            ...
            StaminaIntensity = Config.Bind(d.Section, $"Stance {n} Stamina Intensity", d.Intensity,
                new ConfigDescription(
                    "Multiplicador de intensidade do efeito (drain ou recovery). 0.25=muito baixo · 0.50=baixo · 1.00=normal · 1.50=alto · 2.00=muito alto. Sem efeito se Mode = None.",
                    new AcceptableValueRange<float>(0f, 2f),
                    new ConfigurationManagerAttributes { IsAdvanced = true, Order = 4 })),
            ...
            MovementSpeedMultiplier = Config.Bind(d.Section, $"Stance {n} Movement Speed Multiplier", d.Multiplier,
                new ConfigDescription(
                    "Redutor de velocidade em %. 50 = metade da velocidade · 75 = um pouco mais lento · 100 = sem redução. Apenas redução (limitação do sistema de speed limits do EFT).",
            ...
            ApplyWhenProne = Config.Bind(d.Section, $"Stance {n} Apply When Prone", d.ApplyProne,
                new ConfigDescription(
                    "Aplicar esta stance (offsets, drain/recovery e redutor de velocidade) também quando o personagem está deitado. Desligado por padrão porque pode conflitar com as animações nativas de prone.",
                    null,
