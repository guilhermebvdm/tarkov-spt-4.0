...
**Upstream:** https://github.com/tyfon7/UIFixes.git @ `4ac761ba09c44a2314119a6ef8106b0f0439355a` (branch `(detached)`)
**Forge:** 
...
Grafo do código deste mod (graphify): [`GRAPH_REPORT.md`](../../references/graphs/mods/UIFixes/GRAPH_REPORT.md). Regenerar após mudanças: `/update-mod-graph UIFixes` (ou `bash scripts/update-graphs.sh UIFixes`).

## Comparar modificações com o original

```bash
diff -r mods/UIFixes/original/ mods/UIFixes/modded/
```
...
_Adicionado em 2026-09-05T02:25:51Z_
