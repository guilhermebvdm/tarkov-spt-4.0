    ...
    RandomUtil randomUtil)
{
    ...
    private List<BossLocationSpawn> GeneratePmcWaves(string location, double escapeTimeLimit)
    {
        ...
        var effectiveTimeLimit = Math.Max(escapeTimeLimit, 120);
        var waveCount = Math.Floor((double) (((effectiveTimeLimit * 60) - endWavesAtRemainingTime) - firstWaveTimer) / waveTimer);
