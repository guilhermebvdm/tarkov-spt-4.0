...
**Versão base:** 1.7.0 · **Licença:** MIT
**Upstream:** https://github.com/ArchangelWTF/AmandsGraphics.git @ `5ad92998bc6acdaf9ba90286485e9a96d9c3d962` (branch `main`)
**Forge:** 
...
Grafo do código deste mod (graphify): [`GRAPH_REPORT.md`](../../references/graphs/mods/AmandsGraphics/GRAPH_REPORT.md). Regenerar após mudanças: `/update-mod-graph AmandsGraphics` (ou `bash scripts/update-graphs.sh AmandsGraphics`).

## Comparar modificações com o original

```bash
diff -r mods/AmandsGraphics/original/ mods/AmandsGraphics/modded/
```
...
_Adicionado em 2026-09-15T04:47:22Z_
