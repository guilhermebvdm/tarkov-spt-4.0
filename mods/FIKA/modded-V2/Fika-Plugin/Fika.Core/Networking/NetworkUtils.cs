...
public static class NetworkChannels
{
    ...
    // raid em andamento). Ver backlog/013-canal-qos-dono-inventario, review 01
    // (PA-01-01/PA-01-02), pra evidência de por que "dono do inventário"
    // (comparação de NetId) não é o critério certo. Refina o item 007.
    [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    public static byte GetChannelForSubPacket(Packets.Generic.EGenericSubPacketType type, bool isSinglePeerSend)
    {
        return type switch
        {
            Packets.Generic.EGenericSubPacketType.InventoryOperation => isSinglePeerSend ? ChannelInventory : ChannelGeneral,
            Packets.Generic.EGenericSubPacketType.OperationCallback => isSinglePeerSend ? ChannelInventory : ChannelGeneral,
            _ => ChannelGeneral
        };
    }
}
