...
public sealed class CoopGame : BaseLocalGame<EftGamePlayerOwner>, IFikaGame, IClientHearingTable
{
    ...
    private async Task Reconnect()
    {
        ...
        var position = player != null && !player.Position.Equals(Vector3.zero) ? player.Position : FikaBackendUtils.ReconnectPosition;
        var rotation = player?.MovementContext != null ? player.MovementContext.Rotation : FikaBackendUtils.ReconnectRotation;
