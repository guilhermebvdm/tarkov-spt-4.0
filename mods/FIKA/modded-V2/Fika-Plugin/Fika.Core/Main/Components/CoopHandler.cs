...
#if DEBUG
        // ref: CR-01-01 -- só dispara quando a espera acima de fato iterou (a corrida
        // aconteceu e foi resolvida pelo retry), diferenciando esse caso do caminho
        // "já estava vivo, 0 iterações".
