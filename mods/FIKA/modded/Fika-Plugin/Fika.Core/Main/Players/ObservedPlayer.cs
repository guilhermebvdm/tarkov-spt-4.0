...
public sealed class ObservedPlayer : FikaPlayer
{
    ...
    public override void OnDestroy()
    {
        ...
        if (HealthController.IsAlive && Singleton<IFikaNetworkManager>.Instantiated && Singleton<IFikaNetworkManager>.Instance != null && !Singleton<IFikaNetworkManager>.Instance.ObservedPlayers.Remove(this) && !Profile.Nickname.StartsWith("headless_"))
        {
