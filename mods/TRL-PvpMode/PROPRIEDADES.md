...
> Gerado de [modded/Settings.cs](modded/Settings.cs) em **2026-08-01**, para a **v0.10.0**.
>
...
| Respawn Key | Tecla de renascer | KeyboardShortcut | `Space` | — | Tecla para renascer. Segure-a enquanto estiver caído. |
