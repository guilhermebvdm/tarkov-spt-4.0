...
> Gerado de [modded/Settings.cs](modded/Settings.cs) em **2026-08-01**, para a **v0.9.0**.
>
...
| Respawn Key | Tecla de renascer | KeyboardShortcut | `Home` | — | Tecla para renascer. Segure-a enquanto estiver caído. |
