...
**Versão base:** $(AssemblyVersion) · **Licença:** MIT
**Upstream:** https://github.com/Trinagan/ChangeHelmetVisor @ `b8a27121a4a2b3c4eaa28a9654a9824f32467069` (branch `main`)
**Forge:** 
...
Grafo do código deste mod (graphify): [`GRAPH_REPORT.md`](../../references/graphs/mods/ChangeHelmetVisor/GRAPH_REPORT.md). Regenerar após mudanças: `/update-mod-graph ChangeHelmetVisor` (ou `bash scripts/update-graphs.sh ChangeHelmetVisor`).

## Comparar modificações com o original

```bash
diff -r mods/ChangeHelmetVisor/original/ mods/ChangeHelmetVisor/modded/
```
...
_Adicionado em 2026-06-30T01:19:06Z_
