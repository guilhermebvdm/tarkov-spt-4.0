...
public class GClass165 : BaseLogicLayerSimpleAbstractClass
{
	[NonSerialized]
	public bool Bool_4;
	...
	public GClass165(BotOwner bot, int priority)
		: base(bot, priority)
	{
	}
	...
	{
		return new global::AICoreActionResultStruct<BotLogicDecision, GClass26>(BotLogicDecision.holdPosition, "HoldPos");
	}
