...
public class EFTHardSettings : ScriptableObject
{
	[Serializable]
	...
	public float TinnitusEffectSpeedMultiplier = 3f;
	...
	public float JumpTimeDescendingForStateEnter = 0.1f;

	public float JumpTimeDescendingForStateExit = 0.3f;

	public float ObservedJumpTimeDescendingForStateExit = 0.4f;

	public float VaultingClimbOverTimeDescendingForStateEnter = 0.1f;

	public float VaultingClimbUpTimeDescendingForStateEnter = 0.3f;
	...
	public float SCOPE_ROTATION_THRESHOLD = 1f;
	...
	[Header("Player")]
	public AnimationCurve SprintSpeedImitatorCurve;

	public AnimationCurve WalkSpeedImitatorCurve;

	public AnimationCurve ObservedPlayerStepsImitatorCurve;

	public AnimationCurve ObservedPlayerSprintImitatorCurve;
	...
	[Header("Door")]
	public float DOOR_BREACH_THRESHOLD = 0.8f;

	[Header("Icons")]
	public StaticIcons StaticIcons;

	public ChatSpecialIconSettings ChatSpecialIconSettings;
	...
	public float CULLING_PLAYER_SPHERE_DEAD_BODY_RADIUS = 1.5f;

	public Vector3 CULLING_PLAYER_SPHERE_SHIFT = new Vector3(0f, 1f, 0f);

	public float CULLING_PLAYER_DEAD_BODY_DISTANCE = 5f;

	public float CULLING_PLAYER_DISTANCE = 30f;

	public float CULLING_PLAYER_BALLISTICS_ANGLE = 45f;
	...
	public static EFTHardSettings Instance
	{
		get
		{
			...
			Debug.LogError("Loading EFTHardSettings synchronously can cause CPU spikes. Please load it asynchronously using EFTHardSettings.Load before accessing Instance.");
			_instance = GClass861.Load<EFTHardSettings>("eftsettings");
			return _instance;
		}
	}
	...
	{
		ResourceRequest resourceRequest = Resources.LoadAsync<EFTHardSettings>("eftsettings");
		await GClass841.Await(resourceRequest);
		_instance = (EFTHardSettings)resourceRequest.asset;
	}
	...
	public static void Set(string key, string value)
	{
		...
		if (field != null)
		{
			...
			else
			{
				...
				{
					Debug.LogErrorFormat("value {0} of type {1} not supported", value, field.FieldType);
					return;
				}
	...
	{
		if (_noAimStatesHashSet == null)
		{
			_noAimStatesHashSet = new HashSet<EPlayerState>(NO_AIM_STATES);
		}
		return !_noAimStatesHashSet.Contains(currentStateName);
	}
