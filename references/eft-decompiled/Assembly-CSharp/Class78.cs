...
[CompilerGenerated]
public class Class78<T, U, V, W, X>
{
	[NonSerialized]
	...
	public T serverId => Gparam_0;

	public U results => Gparam_1;

	public V lostInsuredItems => Gparam_2;

	public W transferItems => Gparam_3;

	public X locationTransit => Gparam_4;

	[DebuggerHidden]
	public Class78(T serverId, U results, V lostInsuredItems, W transferItems, X locationTransit)
	{
		Gparam_0 = serverId;
		Gparam_1 = results;
		Gparam_2 = lostInsuredItems;
		Gparam_3 = transferItems;
		Gparam_4 = locationTransit;
	}

	[DebuggerHidden]
	public override bool Equals(object value)
	{
		Class78<T, U, V, W, X> @class = value as Class78<T, U, V, W, X>;
		if (this != @class)
		{
	...
	public override string ToString()
	{
		...
		return string.Format(null, "{{ serverId = {0}, results = {1}, lostInsuredItems = {2}, transferItems = {3}, locationTransit = {4} }}", array);
	}
}
