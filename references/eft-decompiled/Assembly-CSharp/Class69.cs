...
[CompilerGenerated]
public class Class69<T, U, V, W, X>
{
	[NonSerialized]
	...
	public W tools => Gparam_3;

	public X timestamp => Gparam_4;

	[DebuggerHidden]
	public Class69(T Action, U recipeId, V items, W tools, X timestamp)
	{
		Gparam_0 = Action;
		Gparam_1 = recipeId;
		Gparam_2 = items;
	...
	{
		Class69<T, U, V, W, X> @class = value as Class69<T, U, V, W, X>;
		if (this != @class)
		{
	...
	public override string ToString()
	{
		...
		return string.Format(null, "{{ Action = {0}, recipeId = {1}, items = {2}, tools = {3}, timestamp = {4} }}", array);
	}
}
