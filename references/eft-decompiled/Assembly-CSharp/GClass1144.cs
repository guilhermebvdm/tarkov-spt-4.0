...
public class GClass1144 : GClass1141
{
	[NonSerialized]
	...
	public GClass1144(SpatialAudioSystem spatialSystem, Transform listenerTransform, GClass1128 obstructionCalculator, GClass1128 propagationCalculator, LoggerClass logger)
	...
	public override void OnUpdate()
	{
		...
		if (!Bool_1 || Bool_2)
		{
			Gclass1128_1.ManualUpdate(SourceContainerClass, vector3_, Bool_2);
	...
	public override void OnUpdateOcclusionEffects(SourceContainerClass sourceContainer, bool updateImmediately = false)
	{
		...
		{
			base.PropagationEffect = Gclass1128_1.GetScore();
			base.ObstructionEffect = Gclass1128_0.GetScore();
