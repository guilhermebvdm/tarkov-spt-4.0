...
{
	[Serializable]
	public struct AnimatorParameterDefaultValue
	{
		[SerializeField]
		public int _parameterNameHash;

		[SerializeField]
		public AnimatorControllerParameterType _type;

		[SerializeField]
		public int _defaultIntValue;

		[SerializeField]
		public float _defaultFloatValue;

		[SerializeField]
		public bool _defaultBoolValue;
	...
	[Serializable]
	public struct DefaultLayerState(int layerIndex, float weight, int defaultStateHash)
	{
		[SerializeField]
		public int _layerIndex = layerIndex;

		[SerializeField]
		public float _weight = weight;

		[SerializeField]
		public int _defaultStateHash = defaultStateHash;
