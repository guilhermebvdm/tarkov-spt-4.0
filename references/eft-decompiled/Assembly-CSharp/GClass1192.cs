...
public class GClass1192 : GClass1190
{
	[NonSerialized]
	...
	public override EMovementStrategy MovementStrategy => EMovementStrategy.Forward;

	public GClass1192(MonoBehaviour behaviour, GInterface110 posTranslator, Vector3[] points, float[] segmentLengths, float totalLength)
	...
	public IEnumerator method_4(Action onDone = null)
	{
		...
		Float_3 = 1f;
		Vector3 position3 = Vector3_0[Vector3_0.Length - 1];
