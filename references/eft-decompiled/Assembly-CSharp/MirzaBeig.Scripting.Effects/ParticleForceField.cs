...
public abstract class ParticleForceField : MonoBehaviour
{
	...
	public virtual void LateUpdate()
	{
		...
		vector3_0 = base.transform.position + center;
			...
			if (renderer_0[num].isVisible || alwaysUpdate)
			{
				...
				if (simulationSpace == ParticleSystemSimulationSpace.World)
				{
					for (int k = 0; k < particles; k++)
					{
						...
						parameters.scaledDirectionToForceFieldCenter.x = vector3_0.x - parameters.particlePosition.x;
						parameters.scaledDirectionToForceFieldCenter.y = vector3_0.y - parameters.particlePosition.y;
						parameters.scaledDirectionToForceFieldCenter.z = vector3_0.z - parameters.particlePosition.z;
						parameters.distanceToForceFieldCenterSqr = parameters.scaledDirectionToForceFieldCenter.sqrMagnitude;
						if (parameters.distanceToForceFieldCenterSqr < float_1)
						{
							float time = parameters.distanceToForceFieldCenterSqr / float_1;
				...
				else
				{
					...
					for (int l = 0; l < particles; l++)
					{
						...
						float time2 = parameters.distanceToForceFieldCenterSqr / float_1;
