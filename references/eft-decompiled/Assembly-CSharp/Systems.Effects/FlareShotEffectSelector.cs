...
public class FlareShotEffectSelector : MonoBehaviour
{
	[Serializable]
	public struct FlareParameters
	{
	...
	[SerializeField]
	private FlareParameters _blueFlareParameters;
	...
	[Space(10f)]
	[SerializeField]
	protected FlarePatronSound _flarePatronSound;

	public virtual void SetFlareEffect(FlareColorType flareColorType, float lifetime)
	{
		...
		FlareParameters flareParameters = flareColorType switch
		{
			...
			FlareColorType.BlueFlare => _blueFlareParameters, 
