...
public class GPUInstancerSettings : ScriptableObject
{
	...
	{
		public static readonly Class876 class876_0 = new Class876();

		public static Predicate<GPUInstancerSettingsExtension> predicate_0;

		public bool method_0(GPUInstancerSettingsExtension ex)
		{
			return ex == null;
		}
	}
	...
	{
		GPUInstancerSettings gPUInstancerSettings = Resources.Load<GPUInstancerSettings>(GClass1262.SETTINGS_PATH + GClass1262.GPUI_SETTINGS_DEFAULT_NAME);
	...
	{
		return Resources.Load<GPUInstancerShaderBindings>(GClass1262.SETTINGS_PATH + GClass1262.SHADER_BINDINGS_DEFAULT_NAME);
	}
	...
	{
		return Resources.Load<GPUInstancerBillboardAtlasBindings>(GClass1262.SETTINGS_PATH + GClass1262.BILLBOARD_ATLAS_BINDINGS_DEFAULT_NAME);
	}
	...
	{
		return Resources.Load<ShaderVariantCollection>(GClass1262.SETTINGS_PATH + GClass1262.SHADER_VARIANT_COLLECTION_DEFAULT_NAME);
	}

	public virtual void SetDefaultShaderVariants()
	{
		AddShaderVariantToCollection(GClass1262.SHADER_GPUI_SHADOWS_ONLY);
		AddShaderVariantToCollection(GClass1262.SHADER_GPUI_HIZ_OCCLUSION_GENERATOR);
		AddShaderVariantToCollection(GClass1262.SHADER_GPUI_TREE_PROXY);
	}
	...
	public GPUIMatrixHandlingType GetMatrixHandlingType(GPUIPlatform platform)
	{
		...
		while (true)
		{
			if (num < renderingSettingPresets.Count)
			{
				if (renderingSettingPresets[num].platform == platform)
				{
					break;
				}
				num++;
		...
		return renderingSettingPresets[num].matrixHandlingType;
	}
	...
	public GPUIComputeThreadCount GetComputeThreadCount(GPUIPlatform platform)
	{
		...
		return renderingSettingPresets[num].computeThreadCount;
	}
}
