...
public class SelectiveCullingTrigger : DisablerCullingObject
{
	...
	private List<SelectiveCullingTrigger> list_0 = new List<SelectiveCullingTrigger>();
	...
	public void OnParentExit(SelectiveCullingTrigger parent)
	{
		if (list_0.Contains(parent))
		{
			list_0.Remove(parent);
			base.UpdateComponentsStatusOnUpdate();
		}
	}

	public override void UpdateComponentsStatusOnUpdate()
	{
		base.UpdateComponentsStatusOnUpdate();
