...
[Serializable]
[CreateAssetMenu(menuName = "Seasons/WinterMaterialSpeedTree8")]
public class WinterMaterialSpeedTree8 : ScriptableObject, GInterface46, GInterface42
{
	...
	public void Fix()
	{
		...
		Material.SetColor(_hueVariationColor, HueVariation);
		Material.SetColor(_color, Color);
		Logger.LogTrace("WinterMaterialSpeedTree8 material fixed", this);
	}
