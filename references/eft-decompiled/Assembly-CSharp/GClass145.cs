...
public class GClass145 : BaseLogicLayerSimpleAbstractClass
{
	[NonSerialized]
	...
	public GClass145(BotOwner bot, int priority)
		: base(bot, priority)
	{
	...
	public override global::AICoreActionResultStruct<BotLogicDecision, GClass26> GetDecision()
	{
		...
		try
		{
			...
			if (BotOwner_0.Memory.IsInCover)
			{
				...
				{
					return new global::AICoreActionResultStruct<BotLogicDecision, GClass26>(method_18(), "sDistCloseB");
				}
			...
			return new global::AICoreActionResultStruct<BotLogicDecision, GClass26>(method_18(), "HaveCoverSh");
		}
	...
	public BotLogicDecision method_18()
	{
		Vector3 vector = method_17();
		method_13();
		if (Bool_4)
		...
		if (Time.time - Float_9 > 10f && NavMesh.SamplePosition(vector2, out var hit, Float_6, -1))
		{
			...
			BotOwner_0.GoToSomePointData.SetPoint(Vector3_0);
