...
public class ColliderExtrusion : MonoBehaviour
{
	...
	public void SetCollider(Collider newCollider)
	{
		if (newCollider != null)
		{
			if (_collider != null)
			{
				RemoveIgnoredCollider(_collider);
			}
	...
	{
		hashSet_0.Add(collider.GetHashCode());
	}

	public void RemoveIgnoredCollider(Collider collider)
	{
		hashSet_0.Remove(collider.GetHashCode());
	}

	public bool method_1(Collider collider)
	{
		return hashSet_0.Contains(collider.GetHashCode());
	}
