...
public class TwoValueBar : MonoBehaviour
{
	...
	public void SetNew(float value)
	{
		...
		_newFill.anchoredPosition = new Vector2(float_0, _newFill.anchoredPosition.y);
		_newFill.sizeDelta = new Vector2(0f - float_0, _newFill.sizeDelta.y);
		if (!(_newGlow == null))
		{
