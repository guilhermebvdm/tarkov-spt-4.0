...
public class TracerSystem : MonoBehaviour
{
	...
	private LinkedList<Class632> linkedList_0;

	private Class632[] class632_0;
	...
	public void Awake()
	{
		...
		int_0 = Count << 1;
		linkedList_0 = new LinkedList<Class632>();
		class632_0 = new Class632[Count];
		for (int i = 0; i < Count; i++)
		{
			class632_0[i] = new Class632();
			class632_0[i].Pos4 = i << 3;
		}
		int num = int_0 << 2;
	...
	public void LateUpdate()
	{
		...
		foreach (Class632 item in linkedList_0)
		{
	...
	public void Add(Vector3 start, Vector3 end, Color32 color)
	{
		if (class632_0 != null)
		{
			Class632 @class = class632_0[int_1];
			if (++int_1 >= Count)
			{
				int_1 = 0;
			}
