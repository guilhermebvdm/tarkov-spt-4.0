...
public class GClass357 : GClass356
{
	[NonSerialized]
	...
	public GClass357(BotOwner owner)
		: base(owner)
	{
		...
		Gclass104_0 = new GClass104(owner, 60);
		method_0(1, Gclass104_0, activeOnStart: true);
	...
	{
		Gclass104_0.SetCorePosition(pos);
