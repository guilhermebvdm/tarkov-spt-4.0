...
public class DecalProjector : MonoBehaviour
{
	...
	public void Update()
	{
		...
		if (CurrentState != ProjectorState.Unbaked)
		{
		...
		DecalMeshClass decalMesh = MonoBehaviourSingleton<DecalSystem>.Instance.GetDecalMesh(this, ShowSelf);
	...
	public void BakeToUniqueMesh(bool inProjectorSpace = false)
	{
		...
		DecalMeshClass decalMesh = MonoBehaviourSingleton<DecalSystem>.Instance.GetDecalMesh(this, inProjectorSpace: true);
	...
	public static void CreateAndBakeProjector(EftBulletClass hit)
	{
	...
	public static void DrawBloodOnWall(RaycastHit hit)
	{
	...
	public static void BakeDecal(Vector3 hitPoint, Vector3 hitNormal, Collider hitCollider, DecalSystem.SingleDecal decal)
	{
		bool flag = true;
		if (hitCollider != null)
		{
	...
	public static void BakeDecal(EftBulletClass hit, DecalSystem.SingleDecal decal)
	{
		BakeDecal(hit.HitPoint, hit.HitNormal, hit.HitCollider, decal);
	}

	public void BakeDelayed(bool isStatic)
	{
	...
	public IEnumerator WaitAndBake(bool isStaic)
	{
