...
[Serializable]
[CreateAssetMenu(menuName = "Seasons/SpringMaterialFoliage")]
public class SpringMaterialFoliage : ScriptableObject, GInterface44, GInterface42
{
	...
	public void Fix()
	{
		...
		Logger.LogTrace("SpringMaterialFoliage material fixed", this);
	}
}
