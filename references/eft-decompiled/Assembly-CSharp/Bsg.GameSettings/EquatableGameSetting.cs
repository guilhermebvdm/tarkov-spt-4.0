...
{
	public EquatableGameSetting(string key, T defaultValue, Func<T, Task<T>> asyncPreProcessor)
		: base(key, defaultValue, asyncPreProcessor)
	{
	}

	public EquatableGameSetting(string key, T defaultValue, Func<T, T> preProcessor)
