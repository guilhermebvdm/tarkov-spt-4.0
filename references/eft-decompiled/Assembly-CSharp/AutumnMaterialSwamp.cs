...
[CreateAssetMenu(menuName = "Seasons/AutumnMaterialSwamp")]
public class AutumnMaterialSwamp : ScriptableObject, GInterface41, GInterface42
{
	...
	public void Fix()
	{
		...
		Logger.LogTrace("AutumnMaterialSwamp material fixed", this);
	}
}
