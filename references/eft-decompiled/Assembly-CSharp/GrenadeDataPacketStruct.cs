...
public struct GrenadeDataPacketStruct
{
	public int Id;
	...
	[NonSerialized]
	public static GClass1373 Gclass1373_0 = new GClass1373(1f / 64f, BitPackingTag.GrenadeSyncPacketRotationQuantizer);

	[NonSerialized]
	public static GClass1378 Gclass1378_0 = new GClass1378(-80f, 80f, 0.125f, -80f, 80f, 0.125f, -80f, 80f, 0.125f, checkBounds: true);

	[NonSerialized]
	public static GClass1378 Gclass1378_1 = new GClass1378(-500f, 500f, 0.125f, -500f, 500f, 0.125f, -500f, 500f, 0.125f, checkBounds: true);
	...
	public void Deserialize(IDataReader reader)
	{
		...
		if (!Done)
		{
			...
			CollisionNumber = reader.ReadByte();
		}
	}
}
