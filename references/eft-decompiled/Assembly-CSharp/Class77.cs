...
[CompilerGenerated]
public class Class77<T, U, V, W, X>
{
	[NonSerialized]
	...
	public U trader => Gparam_1;

	public V items => Gparam_2;

	public W difference => Gparam_3;

	public X timestamp => Gparam_4;

	[DebuggerHidden]
	public Class77(T Action, U trader, V items, W difference, X timestamp)
	{
		Gparam_0 = Action;
		Gparam_1 = trader;
		Gparam_2 = items;
	...
	{
		Class77<T, U, V, W, X> @class = value as Class77<T, U, V, W, X>;
		if (this != @class)
		{
	...
	public override string ToString()
	{
		...
		return string.Format(null, "{{ Action = {0}, trader = {1}, items = {2}, difference = {3}, timestamp = {4} }}", array);
	}
}
