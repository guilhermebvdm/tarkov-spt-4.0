...
[CreateAssetMenu(menuName = "Seasons/SpringMaterialSwamp")]
public class SpringMaterialSwamp : ScriptableObject, GInterface44, GInterface42
{
	...
	public void Fix()
	{
		...
		Logger.LogTrace("SpringMaterialSwamp material fixed", this);
	}
}
