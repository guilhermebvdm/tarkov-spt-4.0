...
[CompilerGenerated]
public class Class10<T, U, V, W, X>
{
	[NonSerialized]
	...
	public X price => Gparam_4;

	[DebuggerHidden]
	public Class10(T Action, U type, V tid, W items, X price)
	{
		Gparam_0 = Action;
		Gparam_1 = type;
		Gparam_2 = tid;
	...
	{
		Class10<T, U, V, W, X> @class = value as Class10<T, U, V, W, X>;
		if (this != @class)
		{
	...
	public override string ToString()
	{
		...
		return string.Format(null, "{{ Action = {0}, type = {1}, tid = {2}, items = {3}, price = {4} }}", array);
	}
}
