...
public abstract class GClass1262
{
	...
	public abstract class GClass1264
	{
		...
		public static readonly int[] TRANSFORMATION_MATRIX_APPEND_BUFFERS = new int[4]
		{
			Shader.PropertyToID("gpuiTransformationMatrix_LOD0"),
			Shader.PropertyToID("gpuiTransformationMatrix_LOD1"),
			Shader.PropertyToID("gpuiTransformationMatrix_LOD2"),
	...
	public abstract class GClass1265
	{
	...
	public abstract class GClass1266
	{
	...
	public abstract class GClass1267
	{
		...
		public static readonly int COUNT_FACTOR = Shader.PropertyToID("countFactor");
		...
		public static readonly int DETAIL_TERRAIN_NORMAL = Shader.PropertyToID("detailTerrainNormal");
	}

	public abstract class GClass1268
	{
	...
	public abstract class GClass1269
	{
	...
	public static float COMPUTE_SHADER_THREAD_COUNT = 512f;

	public static float COMPUTE_SHADER_THREAD_COUNT_2D = 16f;
	...
	public static readonly string[] CAMERA_COMPUTE_KERNELS = new string[2] { "CSInstancedCameraCalculationKernel", "CSInstancedCameraCalculationKernelCrossFade" };

	public static readonly string[] VISIBILITY_COMPUTE_KERNELS = new string[4] { "CSInstancedRenderingVisibilityKernelLOD0", "CSInstancedRenderingVisibilityKernelLOD1", "CSInstancedRenderingVisibilityKernelLOD2", "CSInstancedRenderingVisibilityKernelLOD3" };
