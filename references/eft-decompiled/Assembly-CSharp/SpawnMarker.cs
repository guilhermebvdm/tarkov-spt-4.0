...
public class SpawnMarker : MonoBehaviour
{
	...
	{
		SpawnMarker spawnMarker = new GameObject($"{side} Marker").AddComponent<SpawnMarker>();
	...
	public void OnDrawGizmos()
	{
		...
		color.a = 0.5f;
		Gizmos.color = color;
		GClass850.DrawWireCube(base.transform.position, base.transform.rotation, new Vector3(1f, 0.01f, 1f));
