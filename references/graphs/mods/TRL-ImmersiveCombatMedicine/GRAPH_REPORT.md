...
## Corpus Check
- 27 files · ~20,778 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 423 nodes · 646 edges · 27 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f58cc4c6`
...
Cohesion: 0.08
Nodes (19): Coroutine, EBandAidPressMode, EBoundItem, GameWorld, IEnumerator, KeyboardShortcut, KeyGroup, BandAidController (+11 more)
...
## Knowledge Gaps
- **139 isolated node(s):** `TRLImmersiveCombatMedicine`, `ConfigEntry`, `bool`, `float`, `ConfigFile` (+134 more)
