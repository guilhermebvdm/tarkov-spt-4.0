...
## Corpus Check
- 104 files · ~91,089 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1588 nodes · 2031 edges · 98 communities (90 shown, 8 thin omitted)
...
- `BulwarkPatch` --inherits--> `ModulePatch`  [EXTRACTED]
  Client/Patches/BulwarkPatch.cs →   _Bridges community 21 → community 84_
...
- `MaxSpeedPatch` --inherits--> `ModulePatch`  [EXTRACTED]
  Client/Patches/ClassMovementPatches.cs →   _Bridges community 21 → community 17_
...
Cohesion: 0.13
Nodes (12): MethodBase, float, MethodBase, ForceEffector, ModulePatch, AdrenalineTriggerPatch, AdsSpeedPatch, AimPunchPatch (+4 more)
...
Cohesion: 0.07
Nodes (18): FieldInfo, MethodBase, PatchPostfix, IEnumerator, MethodBase, PatchPostfix, string, Dictionary (+10 more)
...
## Knowledge Gaps
- **908 isolated node(s):** `float`, `string`, `Dictionary`, `bool`, `Payload` (+903 more)
...
- **Why does `SkillsNavButtonPatch` connect `Community 31` to `Community 21`?**
