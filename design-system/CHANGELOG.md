...
Filtros: `trl-multiselect` (dropdown de checkboxes com count no trigger, counts por opção, Select all/Clear; painel persiste entre cliques) + `trl-filter-chip` (chips de filtros aplicados com remove) — receita "Barra de filtros" no PATTERNS.md.
