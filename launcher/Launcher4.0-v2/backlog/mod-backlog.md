...
- **Fora desse fechamento (não são pendência de teste):** **030** (🟡 — specs prontas, código não iniciado); **026/027** (⚪ — melhorias de segurança deferidas, código não escrito); **011** (⚫ — adiado). Estes seguem no estado real.
