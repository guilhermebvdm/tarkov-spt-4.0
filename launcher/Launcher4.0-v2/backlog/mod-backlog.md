...
|---|---|---|---|---|
| 028 | "Bloquear atualizações" travado com Dev Mode off | 🔴 O toggle mora no painel FERRAMENTAS DEV (some quando o Dev Mode é desligado), mas o gate do auto-update olha **só** o `DisableUpdates` — que persiste. Jogador fica **permanentemente sem atualizar**, sem ver nem poder desfazer pela UI, e o launcher novo (com o fix) **não alcança quem já está preso**. CONFIRMADO em produção (2026-07-11): foi a causa de um jogador não receber a 2.1.0/2.2.1. | [028-bloquear-updates-travado-devmode-off/](./028-bloquear-updates-travado-devmode-off/) | ⚪ |
