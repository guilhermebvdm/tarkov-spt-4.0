...
- Erros já cometidos: [docs/technical/spt-antipatterns.md](docs/technical/spt-antipatterns.md) (AP-01..AP-06) — leitura obrigatória antes de spec/review técnica; checados na §9 da spec técnica, nos critérios padrão da spec funcional e no checklist do fix.
